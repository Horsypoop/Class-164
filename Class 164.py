...
label_planet = Label(root, text="Planet: ", bg="yellow")
label_planet_name = Label(root, font=("courier", 18, "bold"), bg="yellow")
label_planet_image = Label(root, bg="lightblue", highlightthickness=5, borderwidth=2,relief=SOLID)
label_planet_gravity_radius = Label(root, font=("casterallar"), bg="yellow")
label_planet_info = Label(root, font=("courier", 10, "bold"), bg="yellow", wraplength=500)
...
def PlanetInfo():
    ...
    if planet=="Mercury":
        ...
        label_planet_gravity_radious['text'] = "Gravity : 3.7 m/s² \n Radius : 2,439.7 km"
        ...
        label_planet_gravity_radious['text'] = "Gravity : 8.87 m/s² \n Radius : 6,051.8 km"
        ...
        label_planet_gravity_radious['text'] = "Gravity : 9.807 m/s² \n Radius : 6,371 km"
